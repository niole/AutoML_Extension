...
T = TypeVar("T", bound="DominoNucleusDatasetUiAddMountInput")


@_attrs_define
class DominoNucleusDatasetUiAddMountInput:
    """
    Attributes:
        dataset_id (str):
        use_latest (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_nucleus_dataset_ui_add_mount_input = cls(
        ...
        domino_nucleus_dataset_ui_add_mount_input.additional_properties = d
        return domino_nucleus_dataset_ui_add_mount_input
