...
T = TypeVar("T", bound="DominoJobsWebJobStatusChangeSocketEvent")


@_attrs_define
class DominoJobsWebJobStatusChangeSocketEvent:
    """
    Attributes:
        correlation_id (str):
        job_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_jobs_web_job_status_change_socket_event = cls(
        ...
        domino_jobs_web_job_status_change_socket_event.additional_properties = d
        return domino_jobs_web_job_status_change_socket_event
