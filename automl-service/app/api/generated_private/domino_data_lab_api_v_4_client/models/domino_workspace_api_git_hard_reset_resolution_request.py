...
T = TypeVar("T", bound="DominoWorkspaceApiGitHardResetResolutionRequest")


@_attrs_define
class DominoWorkspaceApiGitHardResetResolutionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspace_api_git_hard_reset_resolution_request = cls(
            repositories=repositories,
        )

        domino_workspace_api_git_hard_reset_resolution_request.additional_properties = d
        return domino_workspace_api_git_hard_reset_resolution_request
