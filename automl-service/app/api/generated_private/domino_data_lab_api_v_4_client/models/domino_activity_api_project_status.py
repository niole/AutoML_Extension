...
from ..models.domino_activity_api_project_status_status import DominoActivityApiProjectStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="DominoActivityApiProjectStatus")


@_attrs_define
class DominoActivityApiProjectStatus:
    """
    Attributes:
        status (DominoActivityApiProjectStatusStatus):
        is_blocked (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = DominoActivityApiProjectStatusStatus(d.pop("status"))
        ...
        domino_activity_api_project_status = cls(
            status=status,
        ...
        domino_activity_api_project_status.additional_properties = d
        return domino_activity_api_project_status
