...
T = TypeVar("T", bound="DominoWorkspacesApiDependentRepository")


@_attrs_define
class DominoWorkspacesApiDependentRepository:
    """
    Attributes:
        id (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspaces_api_dependent_repository = cls(
            id=id,
            name=name,
            uri=uri,
            ref=ref,
        ...
        domino_workspaces_api_dependent_repository.additional_properties = d
        return domino_workspaces_api_dependent_repository
