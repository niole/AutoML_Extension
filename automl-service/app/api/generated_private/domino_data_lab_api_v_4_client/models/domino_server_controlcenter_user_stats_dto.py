...
T = TypeVar("T", bound="DominoServerControlcenterUserStatsDTO")


@_attrs_define
class DominoServerControlcenterUserStatsDTO:
    """
    Attributes:
        id (str):
        full_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_server_controlcenter_user_stats_dto = cls(
            id=id,
            full_name=full_name,
        ...
        domino_server_controlcenter_user_stats_dto.additional_properties = d
        return domino_server_controlcenter_user_stats_dto
