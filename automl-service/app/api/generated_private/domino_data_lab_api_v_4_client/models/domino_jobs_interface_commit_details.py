...
T = TypeVar("T", bound="DominoJobsInterfaceCommitDetails")


@_attrs_define
class DominoJobsInterfaceCommitDetails:
    """
    Attributes:
        input_commit_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_jobs_interface_commit_details = cls(
            input_commit_id=input_commit_id,
            output_commit_id=output_commit_id,
        )

        domino_jobs_interface_commit_details.additional_properties = d
        return domino_jobs_interface_commit_details
