...
from ..models.domino_scheduledjob_api_new_scheduled_job_dto_capacity_type import (
    DominoScheduledjobApiNewScheduledJobDtoCapacityType,
)
from ..models.domino_scheduledjob_api_new_scheduled_job_dto_environment_revision_spec_type_0 import (
...
if TYPE_CHECKING:
    ...
    from ..models.domino_scheduledjob_api_new_scheduled_job_dto_environment_revision_spec_type_1 import (
        DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType1,
    )
    from ..models.domino_scheduledjob_api_new_scheduled_job_dto_volume_specification_override_type_0 import (
        DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0,
    )


T = TypeVar("T", bound="DominoScheduledjobApiNewScheduledJobDto")


@_attrs_define
class DominoScheduledjobApiNewScheduledJobDto:
    """
    Attributes:
        title (str):
        command (str):
        ...
        environment_revision_spec (DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType0 |
            DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType1):
        scheduled_by_user_id (str):
        notify_on_complete_email_addresses (list[str]):
        publish_model_id (None | str | Unset):
        capacity_type (DominoScheduledjobApiNewScheduledJobDtoCapacityType | Unset):
        ...
        volume_specification_override (DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0 | None |
            Unset):
    ...
    capacity_type: DominoScheduledjobApiNewScheduledJobDtoCapacityType | Unset = UNSET
    ...
    volume_specification_override: (
        DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(
            self.environment_revision_spec, DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType0
        ):
        ...
        if isinstance(self.volume_specification_override, Unset):
            ...
            self.volume_specification_override, DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_environment_revision_spec(
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                environment_revision_spec_type_0 = DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType0(
                    data
                )
            ...
            environment_revision_spec_type_1 = (
                DominoScheduledjobApiNewScheduledJobDtoEnvironmentRevisionSpecType1.from_dict(data)
            )
        ...
        if isinstance(_capacity_type, Unset):
            ...
            capacity_type = DominoScheduledjobApiNewScheduledJobDtoCapacityType(_capacity_type)
        ...
        def _parse_volume_specification_override(
            ...
            try:
                ...
                volume_specification_override_type_0 = (
                    DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0.from_dict(data)
                )

                return volume_specification_override_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DominoScheduledjobApiNewScheduledJobDtoVolumeSpecificationOverrideType0 | None | Unset, data)
        ...
        domino_scheduledjob_api_new_scheduled_job_dto = cls(
            title=title,
            command=command,
            schedule=schedule,
        ...
        domino_scheduledjob_api_new_scheduled_job_dto.additional_properties = d
        return domino_scheduledjob_api_new_scheduled_job_dto
