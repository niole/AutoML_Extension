...
T = TypeVar("T", bound="DominoWorkspacesApiPaginationFilter")


@_attrs_define
class DominoWorkspacesApiPaginationFilter:
    """
    Attributes:
        limit (int):
        offset (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspaces_api_pagination_filter = cls(
            limit=limit,
            offset=offset,
            latest_time_nano=latest_time_nano,
        )

        domino_workspaces_api_pagination_filter.additional_properties = d
        return domino_workspaces_api_pagination_filter
