...
T = TypeVar("T", bound="DominoModelmanagerWebExportImageForSnowflakeApiRequest")


@_attrs_define
class DominoModelmanagerWebExportImageForSnowflakeApiRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_modelmanager_web_export_image_for_snowflake_api_request = cls(
        ...
        domino_modelmanager_web_export_image_for_snowflake_api_request.additional_properties = d
        return domino_modelmanager_web_export_image_for_snowflake_api_request
