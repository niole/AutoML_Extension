...
from ..models.domino_server_projects_api_project_status_status import DominoServerProjectsApiProjectStatusStatus
from ..types import UNSET, Unset

T = TypeVar("T", bound="DominoServerProjectsApiProjectStatus")


@_attrs_define
class DominoServerProjectsApiProjectStatus:
    """
    Attributes:
        status (DominoServerProjectsApiProjectStatusStatus):
        is_blocked (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = DominoServerProjectsApiProjectStatusStatus(d.pop("status"))
        ...
        domino_server_projects_api_project_status = cls(
            status=status,
        ...
        domino_server_projects_api_project_status.additional_properties = d
        return domino_server_projects_api_project_status
