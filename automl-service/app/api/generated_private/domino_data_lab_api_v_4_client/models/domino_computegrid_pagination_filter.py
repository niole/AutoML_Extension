...
T = TypeVar("T", bound="DominoComputegridPaginationFilter")


@_attrs_define
class DominoComputegridPaginationFilter:
    """
    Attributes:
        limit (int):
        offset (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_computegrid_pagination_filter = cls(
            limit=limit,
            offset=offset,
            latest_time_nano=latest_time_nano,
        )

        domino_computegrid_pagination_filter.additional_properties = d
        return domino_computegrid_pagination_filter
