...
T = TypeVar("T", bound="DominoDatasourceWebDataSourcesAccessedInRunResponse")


@_attrs_define
class DominoDatasourceWebDataSourcesAccessedInRunResponse:
    """
    Attributes:
        run_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_datasource_web_data_sources_accessed_in_run_response = cls(
            run_id=run_id,
            accessed_data_sources=accessed_data_sources,
        )

        domino_datasource_web_data_sources_accessed_in_run_response.additional_properties = d
        return domino_datasource_web_data_sources_accessed_in_run_response
