...
T = TypeVar("T", bound="DominoCommonModelproductAppCodeInfoRepositoryDto")


@_attrs_define
class DominoCommonModelproductAppCodeInfoRepositoryDto:
    """
    Attributes:
        id (str):
        link_text (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_common_modelproduct_app_code_info_repository_dto = cls(
            id=id,
            link_text=link_text,
            full_url=full_url,
            commit=commit,
        ...
        domino_common_modelproduct_app_code_info_repository_dto.additional_properties = d
        return domino_common_modelproduct_app_code_info_repository_dto
