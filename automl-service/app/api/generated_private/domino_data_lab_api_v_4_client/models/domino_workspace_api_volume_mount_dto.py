...
T = TypeVar("T", bound="DominoWorkspaceApiVolumeMountDto")


@_attrs_define
class DominoWorkspaceApiVolumeMountDto:
    """
    Attributes:
        mount_path (str):
        read_only (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspace_api_volume_mount_dto = cls(
            mount_path=mount_path,
            read_only=read_only,
            sub_path=sub_path,
        )

        domino_workspace_api_volume_mount_dto.additional_properties = d
        return domino_workspace_api_volume_mount_dto
