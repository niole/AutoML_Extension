...
from ..models.domino_jobs_interface_compute_cluster_config_spec_dto_compute_environment_revision_spec_type_0 import (
...
if TYPE_CHECKING:
    ...
    from ..models.domino_jobs_interface_compute_cluster_config_spec_dto_compute_environment_revision_spec_type_1 import (
        DominoJobsInterfaceComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1,
    )
    from ..models.domino_jobs_interface_compute_cluster_config_spec_dto_extra_configs_type_0 import (
        DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0,
    )
    from ..models.information import Information


T = TypeVar("T", bound="DominoJobsInterfaceComputeClusterConfigSpecDto")


@_attrs_define
class DominoJobsInterfaceComputeClusterConfigSpecDto:
    """
    Attributes:
        ...
        compute_environment_revision_spec
            (DominoJobsInterfaceComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType0 |
            DominoJobsInterfaceComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1 | None | Unset):
        ...
        extra_configs (DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset):
    """
    ...
    extra_configs: DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra_configs, Unset):
            extra_configs = UNSET
        elif isinstance(self.extra_configs, DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_compute_environment_revision_spec(
            ...
            try:
                ...
                compute_environment_revision_spec_type_0 = (
                    DominoJobsInterfaceComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType0(data)
                )
            ...
            try:
                ...
                compute_environment_revision_spec_type_1 = (
                    DominoJobsInterfaceComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1.from_dict(data)
                )
        ...
        def _parse_extra_configs(
            data: object,
        ) -> DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_configs_type_0 = DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0.from_dict(data)

                return extra_configs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DominoJobsInterfaceComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset, data)

        extra_configs = _parse_extra_configs(d.pop("extraConfigs", UNSET))

        domino_jobs_interface_compute_cluster_config_spec_dto = cls(
        ...
        domino_jobs_interface_compute_cluster_config_spec_dto.additional_properties = d
        return domino_jobs_interface_compute_cluster_config_spec_dto
