...
T = TypeVar("T", bound="DominoJobsInterfaceExecutorInfo")


@_attrs_define
class DominoJobsInterfaceExecutorInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_jobs_interface_executor_info = cls(
        ...
        domino_jobs_interface_executor_info.additional_properties = d
        return domino_jobs_interface_executor_info
