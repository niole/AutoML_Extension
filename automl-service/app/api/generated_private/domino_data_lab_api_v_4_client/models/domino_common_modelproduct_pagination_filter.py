...
T = TypeVar("T", bound="DominoCommonModelproductPaginationFilter")


@_attrs_define
class DominoCommonModelproductPaginationFilter:
    """
    Attributes:
        limit (int):
        offset (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_common_modelproduct_pagination_filter = cls(
            limit=limit,
            offset=offset,
            latest_time_nano=latest_time_nano,
        )

        domino_common_modelproduct_pagination_filter.additional_properties = d
        return domino_common_modelproduct_pagination_filter
