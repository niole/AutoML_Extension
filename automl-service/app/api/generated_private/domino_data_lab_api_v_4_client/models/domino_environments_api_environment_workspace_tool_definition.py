...
if TYPE_CHECKING:
    from ..models.domino_environments_api_proxy_config import DominoEnvironmentsApiProxyConfig


T = TypeVar("T", bound="DominoEnvironmentsApiEnvironmentWorkspaceToolDefinition")


@_attrs_define
class DominoEnvironmentsApiEnvironmentWorkspaceToolDefinition:
    """
    Attributes:
        id (str):
        name (str):
        ...
        proxy_config (DominoEnvironmentsApiProxyConfig | Unset):
    ...
    proxy_config: DominoEnvironmentsApiProxyConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_proxy_config, Unset):
            ...
            proxy_config = DominoEnvironmentsApiProxyConfig.from_dict(_proxy_config)
        ...
        domino_environments_api_environment_workspace_tool_definition = cls(
            id=id,
            name=name,
            title=title,
            start=start,
        ...
        domino_environments_api_environment_workspace_tool_definition.additional_properties = d
        return domino_environments_api_environment_workspace_tool_definition
