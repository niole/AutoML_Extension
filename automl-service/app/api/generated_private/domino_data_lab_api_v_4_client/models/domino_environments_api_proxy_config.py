...
T = TypeVar("T", bound="DominoEnvironmentsApiProxyConfig")


@_attrs_define
class DominoEnvironmentsApiProxyConfig:
    """
    Attributes:
        internal_path (str):
        port (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_environments_api_proxy_config = cls(
        ...
        domino_environments_api_proxy_config.additional_properties = d
        return domino_environments_api_proxy_config
