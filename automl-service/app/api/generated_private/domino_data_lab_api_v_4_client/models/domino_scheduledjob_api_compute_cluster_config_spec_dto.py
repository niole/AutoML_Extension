...
from ..models.domino_scheduledjob_api_compute_cluster_config_spec_dto_compute_environment_revision_spec_type_0 import (
...
if TYPE_CHECKING:
    ...
    from ..models.domino_scheduledjob_api_compute_cluster_config_spec_dto_compute_environment_revision_spec_type_1 import (
        DominoScheduledjobApiComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1,
    )
    from ..models.domino_scheduledjob_api_compute_cluster_config_spec_dto_extra_configs_type_0 import (
        DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0,
    )
    from ..models.information import Information


T = TypeVar("T", bound="DominoScheduledjobApiComputeClusterConfigSpecDto")


@_attrs_define
class DominoScheduledjobApiComputeClusterConfigSpecDto:
    """
    Attributes:
        ...
        compute_environment_revision_spec
            (DominoScheduledjobApiComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType0 |
            DominoScheduledjobApiComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1 | None | Unset):
        ...
        extra_configs (DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset):
    """
    ...
    extra_configs: DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra_configs, Unset):
            extra_configs = UNSET
        elif isinstance(self.extra_configs, DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_compute_environment_revision_spec(
            ...
            try:
                ...
                compute_environment_revision_spec_type_0 = (
                    DominoScheduledjobApiComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType0(data)
                )
            ...
            try:
                ...
                compute_environment_revision_spec_type_1 = (
                    DominoScheduledjobApiComputeClusterConfigSpecDtoComputeEnvironmentRevisionSpecType1.from_dict(data)
                )
        ...
        def _parse_extra_configs(
            data: object,
        ) -> DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_configs_type_0 = DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0.from_dict(data)

                return extra_configs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DominoScheduledjobApiComputeClusterConfigSpecDtoExtraConfigsType0 | None | Unset, data)

        extra_configs = _parse_extra_configs(d.pop("extraConfigs", UNSET))

        domino_scheduledjob_api_compute_cluster_config_spec_dto = cls(
        ...
        domino_scheduledjob_api_compute_cluster_config_spec_dto.additional_properties = d
        return domino_scheduledjob_api_compute_cluster_config_spec_dto
