...
T = TypeVar("T", bound="DominoWorkspaceWebStopClassicWorkspaceRequest")


@_attrs_define
class DominoWorkspaceWebStopClassicWorkspaceRequest:
    """
    Attributes:
        workspace_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspace_web_stop_classic_workspace_request = cls(
            workspace_id=workspace_id,
            commit_message=commit_message,
        )

        domino_workspace_web_stop_classic_workspace_request.additional_properties = d
        return domino_workspace_web_stop_classic_workspace_request
