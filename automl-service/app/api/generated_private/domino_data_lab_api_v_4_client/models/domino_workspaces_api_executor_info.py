...
T = TypeVar("T", bound="DominoWorkspacesApiExecutorInfo")


@_attrs_define
class DominoWorkspacesApiExecutorInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspaces_api_executor_info = cls(
        ...
        domino_workspaces_api_executor_info.additional_properties = d
        return domino_workspaces_api_executor_info
