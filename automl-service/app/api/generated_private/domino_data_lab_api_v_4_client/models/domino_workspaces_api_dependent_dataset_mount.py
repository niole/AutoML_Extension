...
T = TypeVar("T", bound="DominoWorkspacesApiDependentDatasetMount")


@_attrs_define
class DominoWorkspacesApiDependentDatasetMount:
    """
    Attributes:
        dataset_id (str):
        dataset_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspaces_api_dependent_dataset_mount = cls(
        ...
        domino_workspaces_api_dependent_dataset_mount.additional_properties = d
        return domino_workspaces_api_dependent_dataset_mount
