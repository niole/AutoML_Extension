...
if TYPE_CHECKING:
    ...
    from ..models.domino_jobs_interface_compute_cluster_config_spec_with_specific_revision_dto_extra_configs_type_0 import (
        DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0,
    )
    from ..models.information import Information


T = TypeVar("T", bound="DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDto")


@_attrs_define
class DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDto:
    """
    Attributes:
        cluster_type (ComputeClusterType): Type of compute cluster
        compute_environment_id (str):
        compute_environment_revision_spec (Any):
        worker_count (int):
        ...
        extra_configs (DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0 | None |
            Unset):
    """
    ...
    extra_configs: (
        DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0 | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra_configs, Unset):
            ...
            self.extra_configs, DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        compute_environment_revision_spec = d.pop("computeEnvironmentRevisionSpec")
        ...
        def _parse_extra_configs(
            ...
            try:
                ...
                extra_configs_type_0 = (
                    DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0.from_dict(data)
                )
                ...
                pass
            return cast(
                DominoJobsInterfaceComputeClusterConfigSpecWithSpecificRevisionDtoExtraConfigsType0 | None | Unset, data
            )

        extra_configs = _parse_extra_configs(d.pop("extraConfigs", UNSET))

        domino_jobs_interface_compute_cluster_config_spec_with_specific_revision_dto = cls(
        ...
        domino_jobs_interface_compute_cluster_config_spec_with_specific_revision_dto.additional_properties = d
        return domino_jobs_interface_compute_cluster_config_spec_with_specific_revision_dto
