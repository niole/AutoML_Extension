...
T = TypeVar("T", bound="DominoCommonUserCreateReasonForChangeDTO")


@_attrs_define
class DominoCommonUserCreateReasonForChangeDTO:
    """
    Attributes:
        action (str):
        reason (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_common_user_create_reason_for_change_dto = cls(
            action=action,
            reason=reason,
            comment=comment,
        ...
        domino_common_user_create_reason_for_change_dto.additional_properties = d
        return domino_common_user_create_reason_for_change_dto
