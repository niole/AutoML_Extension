...
T = TypeVar("T", bound="DominoWorkspaceApiWorkspaceImportedProject")


@_attrs_define
class DominoWorkspaceApiWorkspaceImportedProject:
    """
    Attributes:
        project_id (str):
        project_name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspace_api_workspace_imported_project = cls(
        ...
        domino_workspace_api_workspace_imported_project.additional_properties = d
        return domino_workspace_api_workspace_imported_project
