...
from ..models.domino_workspace_api_compute_cluster_config_dto_compute_environment_revision_spec_type_0 import (
...
if TYPE_CHECKING:
    ...
    from ..models.domino_workspace_api_compute_cluster_config_dto_compute_environment_revision_spec_type_1 import (
        DominoWorkspaceApiComputeClusterConfigDtoComputeEnvironmentRevisionSpecType1,
    )
    from ..models.domino_workspace_api_compute_cluster_config_dto_extra_configs_type_0 import (
        DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0,
    )
    from ..models.information import Information


T = TypeVar("T", bound="DominoWorkspaceApiComputeClusterConfigDto")


@_attrs_define
class DominoWorkspaceApiComputeClusterConfigDto:
    """
    Attributes:
        ...
        compute_environment_revision_spec (DominoWorkspaceApiComputeClusterConfigDtoComputeEnvironmentRevisionSpecType0
            | DominoWorkspaceApiComputeClusterConfigDtoComputeEnvironmentRevisionSpecType1 | None | Unset):
        ...
        extra_configs (DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0 | None | Unset):
    """
    ...
    extra_configs: DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.extra_configs, Unset):
            extra_configs = UNSET
        elif isinstance(self.extra_configs, DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_compute_environment_revision_spec(
            ...
            try:
                ...
                compute_environment_revision_spec_type_0 = (
                    DominoWorkspaceApiComputeClusterConfigDtoComputeEnvironmentRevisionSpecType0(data)
                )
            ...
            try:
                ...
                compute_environment_revision_spec_type_1 = (
                    DominoWorkspaceApiComputeClusterConfigDtoComputeEnvironmentRevisionSpecType1.from_dict(data)
                )
        ...
        def _parse_extra_configs(
            data: object,
        ) -> DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                extra_configs_type_0 = DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0.from_dict(data)

                return extra_configs_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(DominoWorkspaceApiComputeClusterConfigDtoExtraConfigsType0 | None | Unset, data)

        extra_configs = _parse_extra_configs(d.pop("extraConfigs", UNSET))

        domino_workspace_api_compute_cluster_config_dto = cls(
        ...
        domino_workspace_api_compute_cluster_config_dto.additional_properties = d
        return domino_workspace_api_compute_cluster_config_dto
