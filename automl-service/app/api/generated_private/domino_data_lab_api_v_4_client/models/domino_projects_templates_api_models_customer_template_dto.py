...
if TYPE_CHECKING:
    ...
    from ..models.domino_projects_templates_api_models_source_project_dto import (
    ...
    from ..models.domino_projects_templates_api_models_template_definition_dto import (
...
T = TypeVar("T", bound="DominoProjectsTemplatesApiModelsCustomerTemplateDto")


@_attrs_define
class DominoProjectsTemplatesApiModelsCustomerTemplateDto:
    """
    Attributes:
        id (str):
        name (str):
        ...
        source_project (DominoProjectsTemplatesApiModelsSourceProjectDto):
        definition (DominoProjectsTemplatesApiModelsTemplateDefinitionDto):
        is_archived (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_project = DominoProjectsTemplatesApiModelsSourceProjectDto.from_dict(d.pop("sourceProject"))

        definition = DominoProjectsTemplatesApiModelsTemplateDefinitionDto.from_dict(d.pop("definition"))
        ...
        domino_projects_templates_api_models_customer_template_dto = cls(
            id=id,
            name=name,
            created=created,
            updated=updated,
        ...
        domino_projects_templates_api_models_customer_template_dto.additional_properties = d
        return domino_projects_templates_api_models_customer_template_dto
