...
T = TypeVar("T", bound="DominoJobsInterfaceDependentNetAppVolumeMount")


@_attrs_define
class DominoJobsInterfaceDependentNetAppVolumeMount:
    """
    Attributes:
        pvc_name (str):
        volume_id (str):
        volume_name (str):
        volume_mount (DominoJobsInterfaceVolumeMount | Unset):
        snapshot_mount (DominoJobsInterfaceVolumeMount | Unset):
        other_mounts (list[DominoJobsInterfaceVolumeMount] | None | Unset):
    """

    pvc_name: str
    volume_id: str
    volume_name: str
    volume_mount: DominoJobsInterfaceVolumeMount | Unset = UNSET
    snapshot_mount: DominoJobsInterfaceVolumeMount | Unset = UNSET
    other_mounts: list[DominoJobsInterfaceVolumeMount] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_volume_mount, Unset):
            ...
            volume_mount = DominoJobsInterfaceVolumeMount.from_dict(_volume_mount)
        ...
        if isinstance(_snapshot_mount, Unset):
            ...
            snapshot_mount = DominoJobsInterfaceVolumeMount.from_dict(_snapshot_mount)

        def _parse_other_mounts(data: object) -> list[DominoJobsInterfaceVolumeMount] | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                for other_mounts_type_0_item_data in _other_mounts_type_0:
                    other_mounts_type_0_item = DominoJobsInterfaceVolumeMount.from_dict(other_mounts_type_0_item_data)
                ...
                pass
            return cast(list[DominoJobsInterfaceVolumeMount] | None | Unset, data)

        other_mounts = _parse_other_mounts(d.pop("otherMounts", UNSET))

        domino_jobs_interface_dependent_net_app_volume_mount = cls(
            pvc_name=pvc_name,
            volume_id=volume_id,
        ...
        domino_jobs_interface_dependent_net_app_volume_mount.additional_properties = d
        return domino_jobs_interface_dependent_net_app_volume_mount
