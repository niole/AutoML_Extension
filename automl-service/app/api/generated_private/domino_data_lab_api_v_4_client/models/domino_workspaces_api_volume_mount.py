...
T = TypeVar("T", bound="DominoWorkspacesApiVolumeMount")


@_attrs_define
class DominoWorkspacesApiVolumeMount:
    """
    Attributes:
        mount_path (str):
        read_only (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspaces_api_volume_mount = cls(
            mount_path=mount_path,
            read_only=read_only,
            sub_path=sub_path,
        )

        domino_workspaces_api_volume_mount.additional_properties = d
        return domino_workspaces_api_volume_mount
