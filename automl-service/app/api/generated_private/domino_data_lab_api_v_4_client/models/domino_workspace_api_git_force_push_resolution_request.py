...
T = TypeVar("T", bound="DominoWorkspaceApiGitForcePushResolutionRequest")


@_attrs_define
class DominoWorkspaceApiGitForcePushResolutionRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_workspace_api_git_force_push_resolution_request = cls(
            repositories=repositories,
        )

        domino_workspace_api_git_force_push_resolution_request.additional_properties = d
        return domino_workspace_api_git_force_push_resolution_request
