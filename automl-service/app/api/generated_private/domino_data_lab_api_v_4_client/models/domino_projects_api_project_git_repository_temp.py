...
T = TypeVar("T", bound="DominoProjectsApiProjectGitRepositoryTemp")


@_attrs_define
class DominoProjectsApiProjectGitRepositoryTemp:
    """
    Attributes:
        uri (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_projects_api_project_git_repository_temp = cls(
            uri=uri,
        ...
        domino_projects_api_project_git_repository_temp.additional_properties = d
        return domino_projects_api_project_git_repository_temp
