...
from ..models.domino_admin_interface_on_demand_spark_execution_unit_overview_deployable_object_type import (
    DominoAdminInterfaceOnDemandSparkExecutionUnitOverviewDeployableObjectType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="DominoAdminInterfaceOnDemandSparkExecutionUnitOverview")


@_attrs_define
class DominoAdminInterfaceOnDemandSparkExecutionUnitOverview:
    """
    Attributes:
        deployable_object_type (DominoAdminInterfaceOnDemandSparkExecutionUnitOverviewDeployableObjectType):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        domino_admin_interface_on_demand_spark_execution_unit_overview = cls(
        ...
        domino_admin_interface_on_demand_spark_execution_unit_overview.additional_properties = d
        return domino_admin_interface_on_demand_spark_execution_unit_overview
