...
from ...models.domino_datasetrw_web_update_dataset_rw_storage_request import (
...
def _get_kwargs(
    ...
    *,
    body: DominoDatasetrwWebUpdateDatasetRwStorageRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """Update dataset storage metadata
