...
from ...models.domino_datasetrw_web_create_dataset_request import DominoDatasetrwWebCreateDatasetRequest
from ...types import Response


def _get_kwargs(
    *,
    body: DominoDatasetrwWebCreateDatasetRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    r"""Deprecated - Use the /layout/complete endpoint with the workFlowID \"CreateDataset\" or use the
    public create endpoint. Create dataset
