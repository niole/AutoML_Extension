...
from ...models.domino_datamount_web_create_data_mount_request import DominoDatamountWebCreateDataMountRequest
from ...types import Response


def _get_kwargs(
    *,
    body: DominoDatamountWebCreateDataMountRequest,
) -> dict[str, Any]:
