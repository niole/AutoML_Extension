...
from ...models.domino_nucleus_dataset_ui_create_dataset_input import DominoNucleusDatasetUiCreateDatasetInput
...
def _get_kwargs(
    *,
    body: DominoNucleusDatasetUiCreateDatasetInput,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/datasetUi/collections",
    }
