...
from ...models.domino_nucleus_dataset_ui_add_data_set_tag_input import DominoNucleusDatasetUiAddDataSetTagInput
...
def _get_kwargs(
    dataset_id: str,
    *,
    body: DominoNucleusDatasetUiAddDataSetTagInput,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/datasetUi/collections/{dataset_id}/tags".format(
