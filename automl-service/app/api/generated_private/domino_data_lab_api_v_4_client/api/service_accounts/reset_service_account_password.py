...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/serviceAccounts/{service_account_idp_id}/resetpassword".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Regenerate and synchronize service account's password, update both local storage and keycloak
