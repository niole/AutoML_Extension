...
from ...models.get_provenance_checkpoints_for_execution_sort_order import GetProvenanceCheckpointsForExecutionSortOrder
...
def _get_kwargs(
    ...
    *,
    ...
    sort_order: GetProvenanceCheckpointsForExecutionSortOrder | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/mlflow/execution/{execution_id}/provenanceCheckpoints".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get provenance checkpoints created by an execution. Used to link mlflow runs to the source commit
    that created them
    ...
    Args:
        ...
        sort_by (Any | Unset):
        sort_order (GetProvenanceCheckpointsForExecutionSortOrder | Unset):
