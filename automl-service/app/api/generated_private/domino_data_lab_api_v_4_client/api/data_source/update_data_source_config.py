...
from ...models.domino_datasource_web_update_data_source_config_request import (
...
def _get_kwargs(
    data_source_id: str,
    *,
    body: DominoDatasourceWebUpdateDataSourceConfigRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/datasource/{data_source_id}/config".format(
