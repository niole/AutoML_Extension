...
from ...models.domino_datasource_web_get_admin_users_request import DominoDatasourceWebGetAdminUsersRequest
from ...types import Response


def _get_kwargs(
    *,
    body: DominoDatasourceWebGetAdminUsersRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/datasource/users/admin",
    }
