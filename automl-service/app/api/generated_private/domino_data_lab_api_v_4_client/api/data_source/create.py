...
from ...models.domino_datasource_web_create_data_source_request import DominoDatasourceWebCreateDataSourceRequest
from ...types import Response


def _get_kwargs(
    *,
    body: DominoDatasourceWebCreateDataSourceRequest,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    r"""Deprecated - Use the private /layout/complete endpoint with workFlowID \"CreateDatasource\" or use
    the public create endpoint. Create data source
