...
from ...models.get_real_time_logs_log_type import GetRealTimeLogsLogType
...
def _get_kwargs(
    workspace_id: str,
    *,
    log_type: GetRealTimeLogsLogType | Unset = GetRealTimeLogsLogType.CONSOLE,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/workspaces/{workspace_id}/realTimeLogs".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        workspace_id (str):
        log_type (GetRealTimeLogsLogType | Unset):  Default: GetRealTimeLogsLogType.CONSOLE.
