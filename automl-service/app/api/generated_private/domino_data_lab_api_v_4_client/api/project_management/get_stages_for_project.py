...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projectManagement/project/{project_id}/stage/list".format(
...
) -> DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | list[DominoProjectsApiProjectStage] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | list[DominoProjectsApiProjectStage]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | list[DominoProjectsApiProjectStage]
    """
