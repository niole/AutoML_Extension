...
from ...models.domino_project_management_web_unlink_job_from_goal_request import (
...
def _get_kwargs(
    job_id: str,
    *,
    body: DominoProjectManagementWebUnlinkJobFromGoalRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projectManagement/{job_id}/unlinkJobFromGoal".format(
