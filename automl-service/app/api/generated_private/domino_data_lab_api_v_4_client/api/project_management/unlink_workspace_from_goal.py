...
from ...models.domino_project_management_web_unlink_workspace_from_goal_request import (
...
def _get_kwargs(
    workspace_id: str,
    *,
    body: DominoProjectManagementWebUnlinkWorkspaceFromGoalRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projectManagement/{workspace_id}/unlinkWorkspaceFromGoal".format(
