...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/projectManagement/projectComment/{thread_id}/{comment_id}".format(
...
) -> DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | DominoProjectsApiComment | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | DominoProjectsApiComment]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DominoApiErrorResponse | DominoProjectManagementWebErrorResponse | DominoProjectsApiComment
    """
