...
from ...models.domino_project_management_web_link_file_to_goal_request import (
...
def _get_kwargs(
    *,
    body: DominoProjectManagementWebLinkFileToGoalRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projectManagement/linkFileToGoal",
    }
