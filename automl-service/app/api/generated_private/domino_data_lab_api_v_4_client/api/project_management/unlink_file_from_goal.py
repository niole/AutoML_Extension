...
from ...models.domino_project_management_web_unlink_file_from_goal_request import (
...
def _get_kwargs(
    *,
    body: DominoProjectManagementWebUnlinkFileFromGoalRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projectManagement/unlinkFileFromGoal",
    }
