...
from ...models.domino_project_management_web_link_job_to_goal_request import (
...
def _get_kwargs(
    job_id: str,
    *,
    body: DominoProjectManagementWebLinkJobToGoalRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projectManagement/{job_id}/linkJobToGoal".format(
