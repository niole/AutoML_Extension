...
from ...models.domino_projects_api_repositories_responses_get_repo_browse_api_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/gitRepositories/{repository_id}/git/browse".format(
...
) -> DominoApiErrorResponse | DominoProjectsApiRepositoriesResponsesGetRepoBrowseApiResponse | None:
    if response.status_code == 200:
        response_200 = DominoProjectsApiRepositoriesResponsesGetRepoBrowseApiResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DominoApiErrorResponse | DominoProjectsApiRepositoriesResponsesGetRepoBrowseApiResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        DominoApiErrorResponse | DominoProjectsApiRepositoriesResponsesGetRepoBrowseApiResponse
    """
