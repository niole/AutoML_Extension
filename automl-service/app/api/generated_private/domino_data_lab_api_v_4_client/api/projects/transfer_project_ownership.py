...
from ...models.domino_projects_web_transfer_project_ownership import DominoProjectsWebTransferProjectOwnership
from ...types import Response


def _get_kwargs(
    *,
    body: DominoProjectsWebTransferProjectOwnership,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/transferOwnership",
    }
