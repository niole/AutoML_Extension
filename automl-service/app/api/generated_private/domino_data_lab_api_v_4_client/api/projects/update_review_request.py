...
from ...models.domino_projects_api_update_review_request import DominoProjectsApiUpdateReviewRequest
...
def _get_kwargs(
    ...
    *,
    body: DominoProjectsApiUpdateReviewRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/projects/{project_id}/reviewRequest/{review_request_number}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Update a project review request
