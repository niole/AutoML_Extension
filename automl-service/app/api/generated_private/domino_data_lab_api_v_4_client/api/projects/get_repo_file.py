...
def _get_kwargs(
    ...
    *,
    ...
    is_download: bool | None | Unset = UNSET,
) -> dict[str, Any]:
    ...
    json_is_download: bool | None | Unset
    if isinstance(is_download, Unset):
        json_is_download = UNSET
    else:
        json_is_download = is_download
    params["isDownload"] = json_is_download

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/projects/{project_id}/gitRepositories/{repository_id}/git/raw".format(
