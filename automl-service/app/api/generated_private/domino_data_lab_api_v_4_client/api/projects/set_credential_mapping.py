...
from ...models.domino_projects_web_set_credential_mapping import DominoProjectsWebSetCredentialMapping
...
def _get_kwargs(
    ...
    repo_id: str,
    *,
    body: DominoProjectsWebSetCredentialMapping,
) -> dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """set credential to use for a specific user-project-repo combination
