...
from ...models.domino_projects_web_archive_comment import DominoProjectsWebArchiveComment
...
def _get_kwargs(
    project_id: str,
    *,
    body: DominoProjectsWebArchiveComment,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/projects/{project_id}/archiveCommentOnBlockedProject".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Archive comment on blocked project
