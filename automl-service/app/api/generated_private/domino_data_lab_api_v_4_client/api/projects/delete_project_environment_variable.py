...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/projects/{project_id}/environmentVariables/{environment_variable_name}".format(
            project_id=quote(str(project_id), safe=""),
            environment_variable_name=quote(str(environment_variable_name), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """deletes the environment variable from the specified project
