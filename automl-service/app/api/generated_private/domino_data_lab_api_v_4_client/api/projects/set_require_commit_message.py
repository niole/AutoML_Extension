...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/projects/{project_id}/requireCommitMessage/{require_commit_message}".format(
            project_id=quote(str(project_id), safe=""),
            require_commit_message=quote(str(require_commit_message), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """require a commit message for a project
