...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_to_fork_id}/fork".format(
            project_to_fork_id=quote(str(project_to_fork_id), safe=""),
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    kwargs = _get_kwargs(
        project_to_fork_id=project_to_fork_id,
        body=body,
    )
