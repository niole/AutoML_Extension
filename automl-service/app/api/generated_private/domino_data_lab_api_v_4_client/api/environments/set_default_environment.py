...
from ...models.domino_environments_api_set_deploy_default_env_request import (
...
def _get_kwargs(
    *,
    body: DominoEnvironmentsApiSetDeployDefaultEnvRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/environments/setDefaultEnvironment",
    }
