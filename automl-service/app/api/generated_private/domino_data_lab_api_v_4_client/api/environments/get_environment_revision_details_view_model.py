...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/environments/environmentRevision/{environment_revision_id}".format(
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = DominoEnvironmentsApiEnvironmentRevisionDetails.from_dict(response.json())
