...
from ...models.domino_environments_api_rebuild_environment_revision import (
...
def _get_kwargs(
    *,
    body: DominoEnvironmentsApiRebuildEnvironmentRevision,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/environments/rebuildrevision",
    }
