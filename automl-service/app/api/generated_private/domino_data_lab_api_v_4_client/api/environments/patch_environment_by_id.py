...
from ...models.domino_environments_api_environment_patch import DominoEnvironmentsApiEnvironmentPatch
...
def _get_kwargs(
    environment_id: str,
    *,
    body: DominoEnvironmentsApiEnvironmentPatch,
) -> dict[str, Any]:
