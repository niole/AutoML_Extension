...
from ...models.domino_modelmanager_web_unlinkmodel_from_goal import DominoModelmanagerWebUnlinkmodelFromGoal
...
def _get_kwargs(
    ...
    *,
    body: DominoModelmanagerWebUnlinkmodelFromGoal,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/modelManager/{model_version_id}/unlinkModelFromGoal".format(
