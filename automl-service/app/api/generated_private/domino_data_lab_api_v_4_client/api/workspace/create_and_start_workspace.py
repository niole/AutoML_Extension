...
from ...models.domino_workspace_web_create_workspace_request import DominoWorkspaceWebCreateWorkspaceRequest
...
def _get_kwargs(
    project_id: str,
    *,
    body: DominoWorkspaceWebCreateWorkspaceRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/workspace/project/{project_id}/workspace".format(
