...
from ...models.domino_workspace_web_update_workspace_request import DominoWorkspaceWebUpdateWorkspaceRequest
...
def _get_kwargs(
    ...
    workspace_id: str,
    *,
    body: DominoWorkspaceWebUpdateWorkspaceRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/workspace/project/{project_id}/workspace/{workspace_id}".format(
