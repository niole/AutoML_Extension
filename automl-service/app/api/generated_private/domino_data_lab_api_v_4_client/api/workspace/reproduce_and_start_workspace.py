...
from ...models.domino_workspace_web_reproduce_workspace_request import DominoWorkspaceWebReproduceWorkspaceRequest
...
def _get_kwargs(
    project_id: str,
    *,
    body: DominoWorkspaceWebReproduceWorkspaceRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/workspace/project/{project_id}/reproduceWorkspace".format(
