...
) -> DominoApiErrorResponse | list[Organization] | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DominoApiErrorResponse | list[Organization]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        DominoApiErrorResponse | list[Organization]
    """
