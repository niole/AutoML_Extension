...
from ...models.get_full_credentials_credential_type import GetFullCredentialsCredentialType
...
def _get_kwargs(
    *,
    ...
    credential_type: GetFullCredentialsCredentialType | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        credential_type (GetFullCredentialsCredentialType | Unset):
