...
from ...models.domino_workspaces_web_archive_workspace_input import DominoWorkspacesWebArchiveWorkspaceInput
from ...types import Response


def _get_kwargs(
    *,
    body: DominoWorkspacesWebArchiveWorkspaceInput,
) -> dict[str, Any]:
