...
from ...models.domino_workspaces_web_stop_end_workspace_details import DominoWorkspacesWebStopEndWorkspaceDetails
from ...types import Response


def _get_kwargs(
    *,
    body: DominoWorkspacesWebStopEndWorkspaceDetails,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/workspaces/stop/end",
    }
