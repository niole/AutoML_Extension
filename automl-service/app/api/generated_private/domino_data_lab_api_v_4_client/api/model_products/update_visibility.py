...
from ...models.domino_nucleus_modelproduct_models_visibility_patch import DominoNucleusModelproductModelsVisibilityPatch
...
def _get_kwargs(
    ...
    *,
    body: DominoNucleusModelproductModelsVisibilityPatch,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/modelProducts/{model_product_id}/visibility".format(
