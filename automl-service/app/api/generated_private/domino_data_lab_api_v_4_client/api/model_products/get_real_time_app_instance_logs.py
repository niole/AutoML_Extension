...
from ...models.get_real_time_app_instance_logs_log_type import GetRealTimeAppInstanceLogsLogType
...
def _get_kwargs(
    app_instance_id: str,
    *,
    log_type: GetRealTimeAppInstanceLogsLogType | Unset = GetRealTimeAppInstanceLogsLogType.CONSOLE,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/modelProducts/apps/versions/{app_instance_id}/realTimeLogs".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get the logs of an App Instance without going to s3

    Args:
        app_instance_id (str):
        log_type (GetRealTimeAppInstanceLogsLogType | Unset):  Default:
            GetRealTimeAppInstanceLogsLogType.CONSOLE. Example: console  |  stdout  |  stderr  |
