...
from ...models.domino_nucleus_modelproduct_models_access_request import DominoNucleusModelproductModelsAccessRequest
...
def _get_kwargs(
    ...
    *,
    body: DominoNucleusModelproductModelsAccessRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/modelProducts/{model_product_id}/grantAccess".format(
