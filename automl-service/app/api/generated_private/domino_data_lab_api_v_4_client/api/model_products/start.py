...
from ...models.domino_nucleus_modelproduct_models_start_params import DominoNucleusModelproductModelsStartParams
...
def _get_kwargs(
    ...
    *,
    body: DominoNucleusModelproductModelsStartParams,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/modelProducts/{model_product_id}/start".format(
