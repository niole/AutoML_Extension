...
from ...models.domino_nucleus_user_update_pinned_apps import DominoNucleusUserUpdatePinnedApps
from ...types import Response


def _get_kwargs(
    *,
    body: DominoNucleusUserUpdatePinnedApps,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/users/updatePinnedApps",
    }
