...
from ...models.domino_nucleus_user_update_pinned_projects import DominoNucleusUserUpdatePinnedProjects
from ...types import Response


def _get_kwargs(
    *,
    body: DominoNucleusUserUpdatePinnedProjects,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/users/updatePinnedProjects",
    }
