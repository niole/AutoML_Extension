...
from ...models.domino_guardrails_web_update_comment_request import DominoGuardrailsWebUpdateCommentRequest
...
def _get_kwargs(
    ...
    comment_id: str,
    *,
    body: DominoGuardrailsWebUpdateCommentRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/guardrails/comments/{thread_id}/{comment_id}".format(
