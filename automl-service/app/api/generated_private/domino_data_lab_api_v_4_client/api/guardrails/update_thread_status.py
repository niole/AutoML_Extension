...
from ...models.domino_guardrails_web_update_thread_status_request import DominoGuardrailsWebUpdateThreadStatusRequest
...
def _get_kwargs(
    thread_id: str,
    *,
    body: DominoGuardrailsWebUpdateThreadStatusRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/guardrails/comments/{thread_id}".format(
