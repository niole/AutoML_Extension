...
from ...models.domino_projects_templates_api_models_new_customer_template_dto import (
...
def _get_kwargs(
    *,
    body: DominoProjectsTemplatesApiModelsNewCustomerTemplateDto,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/develop/v1/customer-project-templates",
    }
...
def sync_detailed(
    *,
    ...
    """Create a new customer project template
