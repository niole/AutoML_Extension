...
T = TypeVar("T", bound="BillingTagsModeV1")


@_attrs_define
class BillingTagsModeV1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billing_tags_mode_v1 = cls(
            mode=mode,
        )

        billing_tags_mode_v1.additional_properties = d
        return billing_tags_mode_v1
