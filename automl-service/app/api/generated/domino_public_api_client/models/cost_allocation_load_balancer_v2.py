...
T = TypeVar("T", bound="CostAllocationLoadBalancerV2")


@_attrs_define
class CostAllocationLoadBalancerV2:
    """
    Attributes:
        cost (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_allocation_load_balancer_v2 = cls(
            cost=cost,
            cost_adjustment=cost_adjustment,
        )

        cost_allocation_load_balancer_v2.additional_properties = d
        return cost_allocation_load_balancer_v2
