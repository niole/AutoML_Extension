...
T = TypeVar("T", bound="GitCredentialAccessorEnvelopeV1")


@_attrs_define
class GitCredentialAccessorEnvelopeV1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        git_credential_accessor_envelope_v1 = cls(
            credential=credential,
            metadata=metadata,
        )

        git_credential_accessor_envelope_v1.additional_properties = d
        return git_credential_accessor_envelope_v1
