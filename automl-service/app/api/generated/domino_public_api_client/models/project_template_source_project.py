...
T = TypeVar("T", bound="ProjectTemplateSourceProject")


@_attrs_define
class ProjectTemplateSourceProject:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_template_source_project = cls(
            id=id,
            included=included,
            name=name,
            owner=owner,
        ...
        project_template_source_project.additional_properties = d
        return project_template_source_project
