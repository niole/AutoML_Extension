...
T = TypeVar("T", bound="RegisteredModelVersionUiDetailsV1")


@_attrs_define
class RegisteredModelVersionUiDetailsV1:
    """
    Attributes:
        experiment_run_info (RegisteredModelVersionExperimentRunInfoV1):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        field_dict.update(
            {
                "experimentRunInfo": experiment_run_info,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        experiment_run_info = RegisteredModelVersionExperimentRunInfoV1.from_dict(d.pop("experimentRunInfo"))
        ...
        registered_model_version_ui_details_v1 = cls(
        ...
        registered_model_version_ui_details_v1.additional_properties = d
        return registered_model_version_ui_details_v1
