...
T = TypeVar("T", bound="PaginatedPersonalAccessTokenEnvelope")


@_attrs_define
class PaginatedPersonalAccessTokenEnvelope:
    """
    Attributes:
        metadata (PaginatedMetadataV1):
        tokens (list[PersonalAccessTokenDetails]):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for tokens_item_data in _tokens:
            tokens_item = PersonalAccessTokenDetails.from_dict(tokens_item_data)

            tokens.append(tokens_item)

        paginated_personal_access_token_envelope = cls(
            metadata=metadata,
            tokens=tokens,
        )

        paginated_personal_access_token_envelope.additional_properties = d
        return paginated_personal_access_token_envelope
