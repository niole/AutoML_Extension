...
if TYPE_CHECKING:
    ...
    from ..models.queued_job_status_details_v1 import QueuedJobStatusDetailsV1
    from ..models.stage_times_v1 import StageTimesV1
    from ..models.tag_v1 import TagV1


T = TypeVar("T", bound="JobDetailsV1")
...
class JobDetailsV1:
    ...
    Attributes:
        ...
        queued_job_status_details (QueuedJobStatusDetailsV1 | Unset):
    ...
    queued_job_status_details: QueuedJobStatusDetailsV1 | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        queued_job_status_details: dict[str, Any] | Unset = UNSET
        if not isinstance(self.queued_job_status_details, Unset):
            queued_job_status_details = self.queued_job_status_details.to_dict()
        ...
        if queued_job_status_details is not UNSET:
            field_dict["queuedJobStatusDetails"] = queued_job_status_details
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for tags_item_data in _tags:
            tags_item = TagV1.from_dict(tags_item_data)
        ...
        _queued_job_status_details = d.pop("queuedJobStatusDetails", UNSET)
        queued_job_status_details: QueuedJobStatusDetailsV1 | Unset
        if isinstance(_queued_job_status_details, Unset):
            queued_job_status_details = UNSET
        else:
            queued_job_status_details = QueuedJobStatusDetailsV1.from_dict(_queued_job_status_details)
        ...
        job_details_v1 = cls(
            ...
            queued_job_status_details=queued_job_status_details,
        ...
        job_details_v1.additional_properties = d
        return job_details_v1
