...
T = TypeVar("T", bound="CostAssetsV1Labels")


@_attrs_define
class CostAssetsV1Labels:
    """
    Attributes:
        instance (str | Unset):
        job (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cost_assets_v1_labels.additional_properties = d
        return cost_assets_v1_labels
