...
T = TypeVar("T", bound="RegisteredModelVersionOverviewV1")


@_attrs_define
class RegisteredModelVersionOverviewV1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registered_model_version_overview_v1 = cls(
        ...
        registered_model_version_overview_v1.additional_properties = d
        return registered_model_version_overview_v1
