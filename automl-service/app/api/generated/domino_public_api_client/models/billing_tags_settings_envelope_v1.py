...
T = TypeVar("T", bound="BillingTagsSettingsEnvelopeV1")


@_attrs_define
class BillingTagsSettingsEnvelopeV1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        billing_tags_settings_envelope_v1 = cls(
            mode=mode,
            notifications=notifications,
        )

        billing_tags_settings_envelope_v1.additional_properties = d
        return billing_tags_settings_envelope_v1
