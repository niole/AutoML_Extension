...
if TYPE_CHECKING:
    ...
    from ..models.repo_to_create_v2 import RepoToCreateV2


T = TypeVar("T", bound="NewProjectV2")
...
class NewProjectV2:
    ...
    Attributes:
        ...
        repo_to_create (RepoToCreateV2 | Unset): An object representing a new git repo to create in a remote repository
    ...
    repo_to_create: RepoToCreateV2 | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repo_to_create: RepoToCreateV2 | Unset
        if isinstance(_repo_to_create, Unset):
            repo_to_create = UNSET
        else:
            repo_to_create = RepoToCreateV2.from_dict(_repo_to_create)
        ...
        new_project_v2.additional_properties = d
        return new_project_v2
