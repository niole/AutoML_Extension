...
T = TypeVar("T", bound="ModelEndpointModelSourceV1")


@_attrs_define
class ModelEndpointModelSourceV1:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_endpoint_model_source_v1 = cls(
            hugging_face=hugging_face,
            registered_model=registered_model,
        )

        model_endpoint_model_source_v1.additional_properties = d
        return model_endpoint_model_source_v1
