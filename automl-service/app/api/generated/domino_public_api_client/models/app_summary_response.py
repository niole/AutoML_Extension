...
from ..models.app_summary_response_visibility import AppSummaryResponseVisibility
...
T = TypeVar("T", bound="AppSummaryResponse")


@_attrs_define
class AppSummaryResponse:
    """
    Attributes:
        ...
        entry_point (str):
        id (str):
        is_pinned (bool): Whether this app is pinned by the current user
        mount_datasets (bool):
        ...
        url (str):
        views (float):
        visibility (AppSummaryResponseVisibility):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        visibility = AppSummaryResponseVisibility(d.pop("visibility"))
        ...
        app_summary_response.additional_properties = d
        return app_summary_response
