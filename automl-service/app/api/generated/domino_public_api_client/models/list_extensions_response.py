...
T = TypeVar("T", bound="ListExtensionsResponse")
...
class ListExtensionsResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ExtensionResponse.from_dict(data_item_data)

            data.append(data_item)

        meta = PaginationMeta.from_dict(d.pop("meta"))

        list_extensions_response = cls(
            data=data,
            meta=meta,
        )

        list_extensions_response.additional_properties = d
        return list_extensions_response
