...
T = TypeVar("T", bound="ServiceAccountTokenDetails")


@_attrs_define
class ServiceAccountTokenDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_account_token_details = cls(
        ...
        service_account_token_details.additional_properties = d
        return service_account_token_details
