...
from ...models.get_cost_allocation_v2_response_400 import GetCostAllocationV2Response400
from ...models.get_cost_allocation_v2_response_404 import GetCostAllocationV2Response404
from ...models.get_cost_allocation_v2_response_500 import GetCostAllocationV2Response500
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = GetCostAllocationV2Response400.from_dict(response.json())
    ...
    if response.status_code == 404:
        response_404 = GetCostAllocationV2Response404.from_dict(response.json())

        return response_404

    if response.status_code == 500:
        response_500 = GetCostAllocationV2Response500.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[CostAllocationEnvelopeV2 | FailureEnvelopeV1 | GetCostAllocationV2Response400 | GetCostAllocationV2Response404 | GetCostAllocationV2Response500]
    """
...
def sync(
    *,
    ...
    Returns:
        CostAllocationEnvelopeV2 | FailureEnvelopeV1 | GetCostAllocationV2Response400 | GetCostAllocationV2Response404 | GetCostAllocationV2Response500
    """
