...
from ...models.get_cost_allocation_summary_v2_response_400 import GetCostAllocationSummaryV2Response400
from ...models.get_cost_allocation_summary_v2_response_404 import GetCostAllocationSummaryV2Response404
from ...models.get_cost_allocation_summary_v2_response_500 import GetCostAllocationSummaryV2Response500
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/cost/v2/allocation/summary/accumulated",
        "params": params,
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = GetCostAllocationSummaryV2Response400.from_dict(response.json())
    ...
    if response.status_code == 404:
        response_404 = GetCostAllocationSummaryV2Response404.from_dict(response.json())

        return response_404

    if response.status_code == 500:
        response_500 = GetCostAllocationSummaryV2Response500.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Get accumulated cost allocation summary over a time window
     ...
     Retrieve accumulated cost allocation summary. Faster than the full allocation, but may include less
    details.
    ...
    Returns:
        Response[CostAllocationSummaryEnvelopeV2 | FailureEnvelopeV1 | GetCostAllocationSummaryV2Response400 | GetCostAllocationSummaryV2Response404 | GetCostAllocationSummaryV2Response500]
    """
...
def sync(
    *,
    ...
    Returns:
        CostAllocationSummaryEnvelopeV2 | FailureEnvelopeV1 | GetCostAllocationSummaryV2Response400 | GetCostAllocationSummaryV2Response404 | GetCostAllocationSummaryV2Response500
    """
