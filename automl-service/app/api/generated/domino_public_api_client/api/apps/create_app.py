...
from ...models.app_creation_request import AppCreationRequest
...
) -> AppResponse | CreateAppResponse400 | CreateAppResponse404 | CreateAppResponse500 | FailureEnvelopeV1 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[AppResponse | CreateAppResponse400 | CreateAppResponse404 | CreateAppResponse500 | FailureEnvelopeV1]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        AppResponse | CreateAppResponse400 | CreateAppResponse404 | CreateAppResponse500 | FailureEnvelopeV1
    """
