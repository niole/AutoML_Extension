"""This is a per request auth helper, which stores the Authorization header in
a python context var so that it can be accessed by HTTP request calls deeper in the stack.
"""
